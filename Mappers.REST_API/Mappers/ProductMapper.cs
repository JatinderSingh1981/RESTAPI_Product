    ...
    public class ProductMapper : AutoMapper.Profile
    {
        public ProductMapper()
        {
            ...
            CreateMap<Entity.ProductDetail, ProductDetail>();
                //.ForMember(m => m.PropertyTypeEnum, e => e.MapFrom(et => Enumeration.FromValue<PropertyType>(et.PropertyType)))
                //.ForMember(m => m.LookUpSourceEnum, e => e.MapFrom(et => Enumeration.FromValue<LookupSource>(et.LookUpSource)));
            //.ForMember(m => m.ProductDetail., e => e.MapFrom(et => et.Product.ProductId));

            //CreateMap<Entity.ProductDetail, ProductDesktop>()
            ...
            //CreateMap<ProductDesktop, Entity.ProductDetail>()
